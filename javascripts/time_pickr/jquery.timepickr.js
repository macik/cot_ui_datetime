...
(http://bililite.nfshost.com/blog/2009/07/09/updating-timepickr/)
	Updated 2010-03-25 for jQuery UI 1.8
Modified under license by Andrey Matsovkin
	Updated 2012-09-19 
	+fixed left position of menu
	+fixed element focus on trigger
	+added select trigger on blur event
*/
...
$.widget('ui.timepickr', {
	_init: function() {
		...
		element.bind('click.timepickr', function(){
			ui.show();
			ui.element.focus();
		});
