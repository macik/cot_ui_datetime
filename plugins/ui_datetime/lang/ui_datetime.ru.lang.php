...
$L['uidt_DateTime'] = 'Тест объединенного элемента';
...
$L['cfg_support_touch'] = array('Включить поддержку слайдера на сенсорных устройствах','');
...
<dl class="">
  ...
  <dd>Отобразить исходный (стандартный) элемент ввода даты</dd>
  <dt>data-show="off"</dt>
  <dd>Выключить преобразование стандартных элементов ввода даты/времени</dd>
  <dt>data-dateformat="true"</dt>
  <dd>Отображать формат ввода даты в виде текстовой подсказки после поля ввода</dd>
